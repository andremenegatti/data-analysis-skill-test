...
```{r}
lineplot_tfp(df = tfp, y = rtfpna, title = 'Evolution of TFP - 1955 to 2011',
...
```{r}
lineplot_tfp(df = tfp, y = norm, title = 'Evolution of TFP, normalized to 1955 values - 1955 to 2011',
...
ggplotly(tfp %>% 
  ...
  lineplot_tfp(y = pct_change, ylab = 'Pct. change (%)',
